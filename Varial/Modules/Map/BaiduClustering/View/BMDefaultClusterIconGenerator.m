...
#import "BMDefaultClusterIconGenerator+Testing.h"
...
static NSArray<UIColor *> *kBMBucketBackgroundColors;

@implementation BMDefaultClusterIconGenerator {
  NSCache *_iconCache;
...
- (UIImage *)iconForText:(NSString *)text withBucketIndex:(NSUInteger)bucketIndex {
  ...
  bucketIndex = MIN(bucketIndex, kBMBucketBackgroundColors.count - 1);
  UIColor *backColor = kBMBucketBackgroundColors[bucketIndex];
