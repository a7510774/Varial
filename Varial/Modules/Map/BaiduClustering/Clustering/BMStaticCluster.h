 ...
 */
@interface BMStaticCluster : NSObject<BMCluster>
...
/**
 * Returns a new instance of the BMStaticCluster class defined by it's position.
 */
 ...
 */
@property(nonatomic, readonly) NSArray<id<BMClusterItem>> *items;
