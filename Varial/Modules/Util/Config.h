...
#define SIGNIN_PHONE_NUMBER @"api/v1.0/players/authentication/sign_in_with_phone.php"
#define SUBMIT_OTP @"api/v1.0/players/authentication/submit_otp.php"
#define SUBMIT_LOGIN_OTP @"api/v1.0/players/authentication/signin_otp.php"
