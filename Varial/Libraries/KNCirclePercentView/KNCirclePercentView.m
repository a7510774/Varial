...
- (void)setupBackgroundLayerWithFillColor:(UIColor *)fillColor {
    ...
    self.backgroundLayer.strokeColor = [UIColor greenColor].CGColor;
...
-(void)pauseResumeAnimationWithPercent:(int)percentage {
    ...
    self.percentLabel.text = [NSString stringWithFormat:@"%d%%", percentage];
}
...
//    [self.circle removeAllAnimations];
    ...
    _drawAnimation.duration            = self.duration; // "animate over 10 seconds or so.."
    ...
    [self.circle addAnimation:_drawAnimation forKey:@"drawCircleAnimation"];
