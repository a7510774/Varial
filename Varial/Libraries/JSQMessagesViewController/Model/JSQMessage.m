...
+ (instancetype)messageWithSenderId:(NSString *)senderId
                        displayName:(NSString *)displayName
                               text:(NSString *)text
                             avatar:(JSQMessagesAvatarImage *)avatar
...

{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName date:date isMedia:NO avatar:avatar];
    if (self) {
        _text = [text copy];
    }
    return self;
                          ...
                          avatar:(JSQMessagesAvatarImage *)avatar
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName date:date isMedia:YES avatar:avatar];
    if (self) {
        _media = media;
    }
    return self;
...
{
    return [NSString stringWithFormat:@"<%@: senderId=%@, senderDisplayName=%@, date=%@, isMediaMessage=%@, text=%@, med=%@>",
