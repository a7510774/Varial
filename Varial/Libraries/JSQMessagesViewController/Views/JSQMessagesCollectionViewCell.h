...
@property (weak, nonatomic, readonly) UIImageView *statusImage;
@property (weak, nonatomic) IBOutlet UIView *uploadIndicator;
...
@property (weak, nonatomic) IBOutlet LLARingSpinnerView *downloadSpinner;
@property (weak, nonatomic) IBOutlet UIImageView *outGoingVideo;
@property (weak, nonatomic) IBOutlet UIImageView *incomeVideo;
@property (weak, nonatomic) IBOutlet UIButton *uploadCancel;
@property (weak, nonatomic) IBOutlet UIButton *uploadRetry;
@property (weak, nonatomic) IBOutlet UIButton *downloadCancel;
@property (weak, nonatomic) IBOutlet UIButton *downloadRetry;
@property (weak, nonatomic) IBOutlet UILabel *mediaSize;
@property (weak, nonatomic) IBOutlet UIImageView *missedMedia;
@property (weak, nonatomic) IBOutlet UIImageView *missedOutMedia;
@property (weak, nonatomic) IBOutlet JSQMessagesLabel *activityLabel;
@property (weak, nonatomic) IBOutlet MBCircularProgressBarView *uploadProgress;
