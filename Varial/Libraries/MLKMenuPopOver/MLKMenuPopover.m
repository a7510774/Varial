...
#define MENU_POINTER_RECT       CGRectMake(frame.origin.x + frame.size.width - 20, frame.origin.y, 23, 11)
//#define MENU_POINTER_RECT       CGRectMake(frame.origin.x, frame.origin.y, 23, 11)  // show arrow left side
...
//        [self.containerButton addSubview:menuPointerView];
       ...
       // menuItemsTableView.backgroundView = bgView;
        ...
        [Util createRoundedCorener:menuItemsTableView withCorner:3.0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        [cell.textLabel setFont:[UIFont fontWithName:@"CenturyGothic" size:FONT_SIZE]];
        [cell.textLabel setTextColor:UIColorFromHexCode(GREY_TEXT)];
        if (self.tag == 100) {
