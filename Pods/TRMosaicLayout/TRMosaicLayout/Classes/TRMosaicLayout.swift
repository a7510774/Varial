...
//@objc public enum TRMosaicCellType {
//    case big
//    case small
//}
@objc public enum TRMosaicCellType: Int {
    ...
    func name() -> TRMosaicCellType {
        switch self {
        case .big: return TRMosaicCellType.big
        case .small: return TRMosaicCellType.small
        }
    }
}
@objc public protocol TRMosaicLayoutDelegate {
    
    @objc optional func collectionView(_ collectionView:UICollectionView, mosaicCellSizeTypeAtIndexPath indexPath:IndexPath) -> TRMosaicCellType
    
    @objc optional func collectionView(_ collectionView:UICollectionView, layout collectionViewLayout: TRMosaicLayout, insetAtSection:Int) -> UIEdgeInsets
    
    @objc optional func heightForSmallMosaicCell() -> CGFloat
}

@objc open class TRMosaicLayout: UICollectionViewLayout {
